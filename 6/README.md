...
Import Spring HATEOAS into your project by updating `build.gradle`:
...
Now it's time for you to extend the `rest.domain.Order` class to include link generation by adding the following:
```java
